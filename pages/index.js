...
export const getStaticProps = async () => {
    ...
    async function fetchData() {
        const response = await fetch('https://ikalas.com/api/v1/kik_stats',
            {
                method: 'POST',
                headers: {
            ...
            <div >
                <main>
                            ...
                            <div className="d-flex justify-content-center text-center">
                                <div className="col-12 col-md-8 col-lg-6">
                                    ...
                                    <div className="d-flex justify-content-between MobColumn" >
                                        ...
                                        <div className="">
                                            <h1 className="fw-bold mb-0">
                                                <CountUp end={stats.transactions} />
                                            </h1>
                                            <p className="mb-0">
                                                {_tr("Label2")}
                                            </p>
                    ...
                    <section style={{ position: "relative", overflow: 'hidden', maxHeight: "800px" }} className="bg-white">
                        ...
                        <h2 className='position-absolute text-center' style={{ top: "50%", left: "50%", transform: "translate(-50%,-50%)", color: "white" }}>{_tr("TitleVideo")}
                            <ul className="list-unstyled list-inline list-social mb-6 mb-md-0">
                                <li className="list-inline-item list-social-item me-5">
                                    <a onClick={TwitterLink} rel="noreferrer" className="text-decoration-none" style={{ cursor: "pointer" }}>
                                        <svg className='VideoIcons' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0)"><path d="M24 4.557a9.83 9.83 0 01-2.828.775 4.932 4.932 0 002.165-2.724 9.864 9.864 0 01-3.127 1.195 4.916 4.916 0 00-3.594-1.555c-3.179 0-5.515 2.966-4.797 6.045A13.978 13.978 0 011.671 3.149a4.93 4.93 0 001.523 6.574 4.903 4.903 0 01-2.229-.616c-.054 2.281 1.581 4.415 3.949 4.89a4.935 4.935 0 01-2.224.084 4.928 4.928 0 004.6 3.419A9.9 9.9 0 010 19.54a13.94 13.94 0 007.548 2.212c9.142 0 14.307-7.721 13.995-14.646A10.025 10.025 0 0024 4.557z" fill="#7C69EF" /></g><defs><clipPath id="clip0"><path d="M0 0h24v24H0z" /></clipPath></defs></svg>
                                    </a>
                                </li>
                                <li className="list-inline-item list-social-item me-5">
                                    <a onClick={LinkedinLink} rel="noreferrer" className="text-decoration-none" style={{ cursor: "pointer" }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" className='VideoIcons' viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" fill="#7C69EF" /></svg>
                                    </a>
                                </li>
                                <li className="list-inline-item list-social-item me-5">
                                    <a href="https://www.youtube.com/channel/UChkbRu3hQUNKdbKymsIQtzQ" rel="noreferrer" target="_blank" className="text-decoration-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill='#7C69EF' style={{ enableBackground: "new 0 0 512 512" }} className='VideoIcons'>
                                ...
                                <li className="list-inline-item list-social-item me-5">
                                    <a href="https://github.com/ikalasdev" target="_blank" rel="noreferrer" className="text-decoration-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" className='VideoIcons' fill="#7C69EF" viewBox="0 0 24 24" ><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg>
                                    </a>
                                </li>
                            </ul>
                        </h2>
                    ...
                    <section className="py-12 pt-md-10 bg-white" id="">
                        ...
                        <div style={{ width: "70%" }} className="mx-auto">
                            ...
                            <button className="btn btn-primary mt-4" onClick={CallNewsletterRequest}>{_tr("NewsletterButton")}</button>
                        </div>
                    </section>
